 ...
 function CapsuleSol2() {
  ...
  return (
    <div
      data-color="white"
      ref={container}
      className="capsules  section w-full sm:h-[115vh] 
    ...
    >
      <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start ">
        ...
        <h1 className="w-2/3 font-[Sansita] text-[2.8vh] leading-[4vh] font-medium">
          ...
          leadership. Stay up-to-date on the latest healthcare innovations and
          thought leadership. Stay up-to-date on the latest healthcare
          innovations and thought leadership. Stay up-to-date on the latest
          healthcare innovations and thought leadership. Stay up-to-date on the
          latest healthcare innovations and thought leadership.
        </h1>
      </div>
      <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
        ...
        >
          ...
          <div className="text text-center text-[6vw] sm:text-[3.2vh] font-semibold mt-10 leading-[4.8vh]">
            <h3>
              Equity in Tech: An <br />
              Internation Women&apos;s <br /> Day Conversation Wi <br />
              Caroline Nieto, <br /> Significo&apos;s CPO
            </h3>
          </div>
        ...
        <div
          className="capsule flex flex-col items-center gap-4 p-6 sm:-rotate-[16deg] sm:translate-y-40
                rounded-full border-[1px] border-black"
        >
          <button className="bg-[#e9bbff] text-black px-4 rounded-full text-medium py-3 mb-6 mt-10 font-semibold">
            Thought Leadership
          </button>

          <div className="text text-center text-[3.2vh] flex flex-col gap-6 mb-6 font-semibold leading-[4.8vh]">
            <h3>
              How to Use Digital <br />
              Health Interventions&apos;s <br />
              to Align Employee & <br />
              Organizational Goals
            </h3>
            <h4 className="font-[Sansita] text-[1.9vh] font-medium leading-[2.8vh] text-zinc-500">
              How to use personalized digital health <br /> interventions to
              empower employees while <br />
