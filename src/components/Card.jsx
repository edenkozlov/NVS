...
function Card() {
  ...
  const items = [
    ...
    },
    {
      title: "Blockchain",
      description:
        "Providing secure, immutable data, smart contract development, tokenomics, and zero-knowledge proof technologies to enhance security, transparency, and financial efficiency.",
      image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path  d="M45.9998 10H31.9998L19.7271 26L31.9998 56L59.9998 26L45.9998 10Z" fill="#808080"></path>
    ...
    },
    {
      ...
      description:
        "ransform your ideas into market-ready products with our comprehensive development services. From prototypes and MVPs to SaaS, web, and mobile applications, we offer end-to-end solutions—from planning and design to coding, testing, and ongoing support.",
      image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path  d="M49.0005 54C52.8665 54 56.0005 50.866 56.0005 47C56.0005 43.134 52.8665 40 49.0005 40C45.1345 40 42.0005 43.134 42.0005 47C42.0005 50.866 45.1345 54 49.0005 54Z" fill="#808080"></path>
            <path  d="M15 24C18.866 24 22 20.866 22 17C22 13.134 18.866 10 15 10C11.134 10 8 13.134 8 17C8 20.866 11.134 24 15 24Z" fill="#808080"></path>
      ...
      path: "/BlockchainSolutions",
    },
    {
      title: "Enterprise Software",
      description:
        "Scale seamlessly with our enterprise software solutions: optimize operations with tailored platforms, boost productivity with advanced integrations, and safeguard your infrastructure with robust support systems.",
      image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 26.6667V12C10 11.4696 10.2107 10.9609 10.5858 10.5858C10.9609 10.2107 11.4696 10 12 10H52C52.5304 10 53.0391 10.2107 53.4142 10.5858C53.7893 10.9609 54 11.4696 54 12V26.6667C54 47.6705 36.1735 54.6292 32.6141 55.8093C32.2161 55.9463 31.7839 55.9463 31.386 55.8093C27.8265 54.6292 10 47.6705 10 26.6667Z" fill="#808080"></path>
  ...
  return (
    <div className="card-container flex flex-col sm:flex-row flex-wrap gap-10 mt-20 px-4 sm:px-0">
      {items.map((item, index) => {
        return (
          <div
            key={index}
            className="card w-full sm:w-[30vw] flex flex-col sm:flex-col items-center text-center gap-4 border-[1px] border-[--black] py-8 px-8"
          >
            <h1 className="text-[3vh] font-bold whitespace-nowrap sm:text-[2.8vh] mb-2">
              {item.title}
            </h1>
            <div
...
function Card() {
  ...
  { 
  title: "Advisory", 
  description: "Leverage strategic expertise from our fractional CTOs, gain comprehensive technical assessments, and speed up your development with specialized backend, frontend, and DevOps solutions.",
  image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { 
              title: "Blockchain", 
              description: "Providing secure, immutable data, smart contract development, tokenomics, and zero-knowledge proof technologies to enhance security, transparency, and financial efficiency.",
  image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          { 
              title: "Product Development", 
              description: "ransform your ideas into market-ready products with our comprehensive development services. From prototypes and MVPs to SaaS, web, and mobile applications, we offer end-to-end solutions—from planning and design to coding, testing, and ongoing support.",
              image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { 
  title: "Enterprise Software", 
  description: "Scale seamlessly with our enterprise software solutions: optimize operations with tailored platforms, boost productivity with advanced integrations, and safeguard your infrastructure with robust support systems.",
  image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="card-container flex sm:flex-col gap-10 mt-20">
      {items.map((item, index) => {
        return (
          <div
            key={index}
            className="card min-w-[40vh] sm:w-[30vw] sm:flex items-center gap-6
