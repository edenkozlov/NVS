      ...
      <div className="cont h-[400vh] relative">
        ...
        >
          ...
          >
            ...
            >
              <h1 className="">Our Exceptional</h1>
          ...
          >
            ...
            <div className="w-[60%] text-center font-[SansitaReg] relative">
              ...
              >
                Our mission at KMG Technologies is to craft innovative software
                that drives growth, streamlines operations, and transforms
                challenges into scalable, user-centric solutions.
              </h3>
          ...
          >
            ...
            <div className="w-[60%] text-center font-[SansitaReg] relative">
              ...
              <h3 className="text-[3.5vh] whitespace-nowrap sm:text-[6vh] font-semibold sm:leading-[6vh]">
                Dollars securly 
                <br></br>managed for <br></br>clients 
              </h3>
            </div>
            <div
